...
![](image/e1cfd3ce0032867ebcb16dbcb5c06743.png)
...
![](image/74982d54ff7df37618ef186ec7dad049.png ":size=40%")
...
![](image/23f558de081b9a9a2a5da93fdc1989df.png ":size=80%")
...
- 为了提}高数据读写的速度，Java API提供了带缓冲功能的流类，在使用这些流类时，会创建一个内部缓冲区数组，缺省使用8192个字节(8Kb)的缓冲区。
  ...
  ![](image/b127ea9bd12c05a70b88033ee70bf2f3.png ":size=70%")
...
![](image/7ce79819b9685ffc2bae685bec83b0f1.png ":size=90%")
...
![](image/4dfa85f71b54ed2d8e3a43371933b7fb.png ":size=80%")
...
![](image/b886d2a72df648a1e6bd5ffcf2db9dc3.png ":size=80%")

![](image/35ad9abbbf83b4ea957ce978bac16873.png ":size=80%")
...
![](image/6b9b053461f8e826c26a05b5165f0554.png)

![img](image/136c25b4e21abb2636a8e2da960c62d1.png)

![img](image/8982f1154c6cb449ecf5695d8f1142cf.png)
