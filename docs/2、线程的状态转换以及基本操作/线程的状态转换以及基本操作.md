...
![](img(线程的状态转换以及基本操作)/futureTask接口实现关系-16482162634225.png)
...
# 2. 线程状态转换
![线程状态转换关系](img(线程的状态转换以及基本操作)/线程状态转换关系-16482163167647.png)
...
![线程状态](img(线程的状态转换以及基本操作)/线程状态-16482163576159.png)
...
![中断线程方法](img(线程的状态转换以及基本操作)/中断线程方法-164821637606711.png)
